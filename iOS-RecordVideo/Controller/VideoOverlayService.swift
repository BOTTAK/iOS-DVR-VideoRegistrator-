...
class VideoOverlayService {
    ...
    func addOverlayToVideo(videoUrl: URL, outputUrl: URL, type: AVFileType, texts: [(start: Double, duration: Double, text: String)], progress progressClosure: @escaping (_ progress: Float) -> (), completion: @escaping (_ url: URL?) -> (), failure: @escaping (_ error: Swift.Error?) -> ()) {
